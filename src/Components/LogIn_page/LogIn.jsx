...
function LogIn() {
  return (
    <div className=" grid place-items-center w-screen h-screen bg-gradient-to-r from-indigo-300 via-purple-200 to-pink-300 ...">
      <div className="bg-gray-400 w-3/4 h-4/5 flex rounded-xl">
        <div className=" bg-slate-500 rounded-xl m-5 p-4 w-[50%]">
        <h1 className="font-bold text-xl"><Link to="/"> <ArrowBackIcon/> </Link></h1>
        ...
        <div className="m-5 p-5 w-[50%]">
          ...
          <div className="my-10 w-full">
            ...
            <div className="flex flex-col items-center mt-6">
              <p >or <span className="text-black text-lg">Continue</span> with</p>

              <div className="flex justify-evenly w-full my-4">
                <div className=" bg-gray-300 rounded-lg w-12 h-12 grid place-items-center hover:bg-gray-900 hover:text-white"><GoogleIcon /></div>
                <div className=" bg-gray-300 rounded-lg w-12 h-12 grid place-items-center hover:bg-gray-900 hover:text-white"><XIcon/></div>
                <div className=" bg-gray-300 rounded-lg w-12 h-12 grid place-items-center hover:bg-gray-900 hover:text-white"><InstagramIcon/></div>
              </div>

              <p className="my-2">Don't have an account yet? 
                <Link to="#" className="font-bold text-gray-800 hover:text-white">
                  Sign up
                </Link>
              </p>
              <p className="my-2">
                By clicking the above login, you agree to our <span className=" underline">Terms & Tonditions.</span>
              </p>
